/**
 * Processes all target sheets in the active spreadsheet.
 *
 * Target sheets are sheets whose names start with "=". A sheet is processed only
 * when the value in G4 has changed since the previous successful run.
 */
